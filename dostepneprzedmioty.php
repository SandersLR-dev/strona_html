  ...
  <div class="w3-row">
    ...
    <div class="middle">
        <div class="w3-container">
         <h4 class="w3-center">Przedmioty</h4>
         <p class="w3-center"><img src="nauka.jpg" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p>
                ...
                echo '<div class="blok" >';
                   ...
                   echo $wynik['Nazwa'];
                   echo '</h6>';
                   echo '<form method="post" action="dostepninauczyciele.php">';
                   echo '<div class="w3-center">';
                    echo'<button type="submit" name="przedmiot" value='.$wynik['PrzedmiotID'].' class="w3-button w3-theme w3-round-xlarge "><i ></i> Wybierz</button> ';
                   echo '</div>';
                   echo '</form>';       
                echo '</div>';
                }
