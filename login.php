  ...
  <div class="w3-row">
    ...
    <div class="middle" >
        <div class="w3-container">
         <h4 class="w3-center">Logowanie</h4>
      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            ...
            <label>Hasło <br/><input name="haslo" type="password" ></label><br/><br/>
              <button type="submit" name="zaloguj" class="w3-button w3-theme"><i ></i> Zaloguj !!!</button> 
                </form>
